import { addFacilityNewCardForm,AddFacilityNewCardFormHandler } from '../../../services/pages/popup-form/AddFacilityNewCardForm.service';
...
export const AddNewFacilityCard = (props: { handleClose: (res: boolean) => void}) => {
  const router = useNavigate();

  const handleCard = async () => {
    const res = await AddFacilityNewCardFormHandler(router);
          ...
          <Container maxWidth="lg">
            <Box className="main-box">
              <Box sx={{ bgcolor: 'background.paper' }}>
                ...
                <FieldGroup
                  control={addFacilityNewCardForm}
                  render={() => (
                    <form>
                      <Box>
